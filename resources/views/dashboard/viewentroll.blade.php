@extends('layouts.app')
@section('title', 'Start Entrollment')
@section('content')
    <div class="row">
        <div class="col-md d-flex align-items-strech">
            <div class="card w-100">
                <div class="card-body">
                    <h2 class="fw-bolder mb-3">Let's Entroll <i class="ti ti-fingerprint"></i></h2>

                    <div class="container">
                        <div id="controls" class="row justify-content-center mx-5 mx-sm-0 mx-lg-5 mt-4">
                            <div class="col-sm mb-2 ml-sm-5">
                                <button id="createEnrollmentButton" type="button" class="btn btn-lg w-100 btn-primary btn-block" data-toggle="modal" data-target="#createEnrollment" onclick="beginEnrollment()">Start Enrollment <i class="ti ti-fingerprint"></i></button>
                            </div>
                        </div>
                    </div>
